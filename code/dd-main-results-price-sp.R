...
stargazer(df_models_sp$felm_models, type = 'text',
          out = 'results/dd-main-results/price/dd-price-sp.txt')

stargazer(df_models_sp$felm_models,
          out = 'results/dd-main-results/price/dd-price-sp-tex.tex',
...
df_models_sp %>% 
  ...
  select(-lm_models) %>% 
  saveRDS('results/dd-main-results/price/dd-price-sp-full-results.rds')