...
stargazer(df_models_brasil$felm_models, type = 'text',
          out = 'results/dd-main-results/bidders/dd-bidders-br.txt')

stargazer(df_models_brasil$felm_models,
          out = 'results/dd-main-results/bidders/dd-bidders-br-latex.tex',
...
df_models_brasil %>% 
  ...
  select(-lm_models) %>% 
  saveRDS('results/dd-main-results/bidders/dd-bidders-br-full-results.rds')